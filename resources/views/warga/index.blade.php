    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900 dark:text-white overflow-x-auto">
            ...
            <div class="p-4 max-h-[90vh] overflow-y-auto text-sm text-gray-700 dark:text-white">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div id="detail_lahir" class="mt-1 px-3 py-2 border rounded bg-gray-100 dark:bg-gray-700"></div>
                    </div>
                    <div>
                        <label class="block font-medium">Agama</label>
                        <div id="detail_agama" class="mt-1 px-3 py-2 border rounded bg-gray-100 dark:bg-gray-700"></div>
                    </div>
                    <div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div id="detail_nokk" class="mt-1 px-3 py-2 border rounded bg-gray-100 dark:bg-gray-700"></div>
                    </div>
                </div>
